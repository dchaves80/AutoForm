...
{
    public partial class Form_08_Dorso : UserControl
    {

        public Extras.LinesControl _LC;
        public Form_08_Dorso()
        {
            InitializeComponent();
        }

        private void Form_08_Dorso_Load(object sender, EventArgs e)
        {
            _LC = new Extras.LinesControl(txtMObservaciones, false,210,5);
        }
